...
To get reduced key, define parameters order and key in `input.text`
If you want to get reduced key, set order to `1` and key to original key.
If you want to get original key, set order to `2` and key to reduced key.

To get result, run Reducekey.exe. The result will appear in `output.txt`

-sample to get reduced key.

input: `1 024e34ddb0c35faa658f76589b085294bf5c8a1e9ff43a0236edc5d3969e58ade5`
output: `58a9fef402026635c9c9cef574f427`

-sample to get original key.

input: `2 58a9fef402026635c9c9cef574f427`
output: `024e34ddb0c35faa658f76589b085294bf5c8a1e9ff43a0236edc5d3969e58ade5`
